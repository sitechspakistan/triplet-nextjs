    ...
    return (
        <>
            ...
            <ShadowRightSec VideoUrl={"https://player.vimeo.com/video/616238804?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479"}
                ...
                btnlink={"/get-a-quote"} Btntxt={"Get In Touch"} datahov={"Get In Touch"} />
            <ShadowLeftSec Heading={"Partner with a Team Trusted by Global Giants"}
                ...
                btnlink={"/book-a-metting"} Btntxt={"Book Your Consultation Now"} datahov={"Book Your Consultation Now"} />
            <ShadowRightSec VideoUrl={"https://player.vimeo.com/video/616253550?badge=0&autopause=0&player_id=0&app_id=58479/embed"}
                ...
                btnlink={"/book-a-metting"} Btntxt={"Get Started With a Free consultation"} datahov={"Get Started With a Free consultation"} />
            <ShadowLeftSec VideoUrl={"/assets/images/explainer-video/explainer-image2.png"}
                ...
                btnlink={"/book-a-metting"} Btntxt={"Schedule Free Consultation"} datahov={"Schedule Free Consultation"} />
            <PortfolioSlider />
            <Faqs />
            <ContactForm />
        </>
